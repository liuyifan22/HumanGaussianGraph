...
class MvhumanDataset(Dataset):
    ...
    def __init__(self, opt: Options, training=True):
        ...
        if self.training:
            self.items = self.items[:-select] # for debugging, use 1, else, self.opt.batch_size
        else:
    ...
    def get_single_frame(self, human_idx, pose_idx):
        ...
        all_vids = ["22236222",  "22236234",  "22236236",  "22327084",  "22327102",  "22327109",  "22327113",  "22327117", "22236229",  "22236235",  "22327073",  "22327091",  "22327107",  "22327111",  "22327116",  "22327118"]
        ortho_vids = [
        "22327091",
        "22327116",
        "22236236",
