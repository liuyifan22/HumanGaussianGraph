...
class GaussianRenderer:
    ...
    def render(self, gaussians, cam_view, cam_view_proj, cam_pos, bg_color=None, scale_modifier=1, image_height=1024, image_width=1224):
        # gaussians: [B, N, 14]
        ...
        for b in range(B):
            ...
            for v in range(V):
                ...
                raster_settings = GaussianRasterizationSettings(
                    ...
                    image_width=image_width, #self.opt.output_size,
        ...
        images = torch.stack(images, dim=0).view(B, V, 3, image_height, image_width)
        alphas = torch.stack(alphas, dim=0).view(B, V, 1, image_height, image_width)
