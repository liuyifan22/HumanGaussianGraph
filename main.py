...
def main():    
    ...
    # data
    if opt.data_mode == 's3':
        from core.provider_mvhuman import MvhumanDataset as Dataset
    else:
        ...
        with torch.no_grad():
            ...
            for i, data in enumerate(test_dataloader):
                ...
                if accelerator.is_main_process:
                    ...
                    data_last = data[key_list[-1]]
                    gt_images = data_last['images_output'].detach().cpu().numpy() # [B, V, 3, output_size, output_size]
