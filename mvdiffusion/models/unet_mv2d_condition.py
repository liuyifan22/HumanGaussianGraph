...
class UNetMV2DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def __init__(
        ...
        """ embedding for smpl, zero init"""
        # self.longer_class_embedding = nn.Linear(20, time_embed_dim)
        # nn.init.zeros_(self.longer_class_embedding.weight)
        # nn.init.zeros_(self.longer_class_embedding.bias)
